...
//- (void)callWillStart:(GSCall*)call;
- (void)callDidEnd:(GSCall*)call error:(NSError*)err;
@end
...
@property (nonatomic, readonly) GSCallInfo *info; ///< Available only after `-begin` method is called.
//@property (nonatomic, readonly) NSString *remoteAddress; ///< Remote address for outgoing or incoming call. Has both local and domain part, e.g. @"john@sip.com"
...
@property (nonatomic, assign) NSObject <GSCallDelegate> *delegate; ///< Call delegate.
